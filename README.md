...
The rules, the interface and the artwork are all new;
the piece set is generated by `packaging/generate-pieces.py`.

## Licence

Apache-2.0. See [LICENSE](LICENSE); [NOTICE](NOTICE) records the project's history
and the original authors.

Versions up to and including the 2012 program were GPL-3.0-or-later and remain
available under those terms in this repository's history.
